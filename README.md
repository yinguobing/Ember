...
| 文末CTA · 标题 | 文章/页面底部咨询区块的标题 |
| 文末CTA · 文案 | 咨询区块正文；**留空则整块不渲染** |
| 文末CTA · 二维码 | 二维码图片地址（如微信号） |
| 文末CTA · 链接 | 「看我能做什么」按钮指向的地址 |

> 文末咨询 CTA 区块是「空默认」：只有填了「文末CTA · 文案」的站点才会渲染。
> 主题文件本身不含任何站点专属内容，克隆本主题不会带出原作者的姓名、二维码或链接。
